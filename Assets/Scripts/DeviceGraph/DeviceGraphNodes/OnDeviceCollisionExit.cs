...
namespace DeviceGraph {
    ...
    public class OnDeviceCollisionExitNode : DeviceComponentNode {

        public string module_id;

        public void exit_collision(DeviceContext ctx, object _other) {
        ...
        public override void init(DeviceContext ctx, DeviceConfig[] config) {
            ctx.device.add_component(new DeviceCollisionExit(this), false);
        }
